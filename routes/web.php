...
Route::group(['middleware' => 'role:kasir','auth'], function () {
   ...
   // Route::get('order/{order}/receiptt', 'OrderController@receiptt')->name('receiptt');
    //Route::get('/order/cetak_pdf', 'ImvoiceController@cetak_pdf');
   //Route::get("receipt","ImvoiceController@downloadPDF");
});
